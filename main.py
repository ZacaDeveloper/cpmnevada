...
__CHANNEL_USERNAME__ = "zacadev"
__GROUP_USERNAME__   = "termcar"
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '\t         PLEASE LOGOUT FROM CPM BEFORE USING THIS TOOL'))
    print(Colorate.Horizontal(Colors.rainbow, '    SHARING THE ACCESS KEY IS NOT ALLOWED AND WILL BE BLOCKED'))
    print(Colorate.Horizontal(Colors.rainbow, f'            Telegram: @{__CHANNEL_USERNAME__} Or @{__GROUP_USERNAME__}'))
    print(Colorate.Horizontal(Colors.rainbow, '============================================================'))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ Nevada ]==============='))
